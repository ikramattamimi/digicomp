...
const LaporanAnggotaPage = forwardRef((props, ref) => {
  ...
  useEffect(() => {
    ...
    const peserta = {
      ...
      nilai: nPeserta,
      sum: GetSum(nPeserta),
      kualifikasi: GetKualifikasi(GetSum(nPeserta)),
    };
    ...
    const mentor = {
      ...
      nilai: nMentor,
      sum: GetSum(nMentor),
      kualifikasi: GetKualifikasi(GetSum(nMentor)),
    };
    ...
    setNilai([peserta, mentor, rataan, kualifperkomp]);
  }, []);
